...
const CH_SECRET = process.env.LINE_CHANNEL_SECRET_2 || 'null'; //Channel Secretを指定
const CH_ACCESS_TOKEN = process.env.LINE_CHANNEL_ACCESS_TOKEN_2 || 'null'; //Channel Access Tokenを指定
